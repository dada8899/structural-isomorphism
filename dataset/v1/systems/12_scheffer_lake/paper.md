***REMOVED*** Early Warning Indicators in Lake Dissolved Oxygen Time Series: Test of Scheffer Fold-Bifurcation Universality

**Project:** structural-isomorphism v4
**Validation track:** A2-Scheffer (taxonomy class ***REMOVED***3: fold bifurcation / regime shift)
...
***REMOVED******REMOVED******REMOVED*** 1.1 Test system
...
***REMOVED******REMOVED******REMOVED*** 1.2 Hypotheses
...
***REMOVED******REMOVED******REMOVED*** 3.1 Detrending
...
***REMOVED******REMOVED******REMOVED*** 3.2 Changepoint detection: CUSUM
...
***REMOVED******REMOVED******REMOVED*** 3.3 Early-warning indicators
...
***REMOVED******REMOVED******REMOVED*** 3.4 Trend tests
...
***REMOVED******REMOVED******REMOVED*** 4.1 Global secular trend
...
***REMOVED******REMOVED******REMOVED*** 4.2 Per-event analysis
...
***REMOVED******REMOVED******REMOVED*** 4.3 Skewness behavior
...
***REMOVED******REMOVED******REMOVED*** 5.1 Confirming the secular CSD signature
...
***REMOVED******REMOVED******REMOVED*** 5.2 Qualifying the per-event signature
...
***REMOVED******REMOVED******REMOVED*** 5.3 Limitations
