***REMOVED*** Criticality Without Mean-Field SOC: Neural Avalanche Scaling on Task-Active Mouse Cortex
...
***REMOVED******REMOVED******REMOVED*** 3.3 What the real-data table tells us
...
***REMOVED******REMOVED*** 4. Joint five-phase comparison
