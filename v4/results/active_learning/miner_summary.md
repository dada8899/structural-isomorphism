...
- `hysteresis_preisach`: 10 pairs
- `markov_chain_memory_fidelity_class`: 3 pairs
- `scale_free_percolation_class`: 6 pairs
- `schelling_credible_commitment`: 10 pairs
- `tail_copula_contagion`: 10 pairs
