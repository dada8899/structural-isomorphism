...
***REMOVED******REMOVED*** Setup note (critical caveat)
...
***REMOVED******REMOVED*** Per-class agreement table
...
***REMOVED******REMOVED******REMOVED*** What B4 destabilises
...
```bash
***REMOVED*** Cross-tabulate B3 (full) and B4 (sample) verdicts
.venv/bin/python -c "
import json, re
