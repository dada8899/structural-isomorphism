***REMOVED*** Adversarial Pre-Registration
...
***REMOVED******REMOVED*** Why pre-register?
...
***REMOVED******REMOVED*** How it works (the rule, not the wish)
...
***REMOVED******REMOVED*** Why these 3 systems for W1-C
...
***REMOVED******REMOVED*** What "PASS" means (and does not)
...
***REMOVED******REMOVED*** What's locked vs what's not
...
***REMOVED******REMOVED*** Re-running a pre-registration
...
***REMOVED******REMOVED*** Honest accounting
