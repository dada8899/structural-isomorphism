"""Deterministic primitive tests for v4/lib/soc_pipeline.
...
def test_rejects_lognormal():
    ...
    result = fit_clauset_powerlaw(samples, name="synthetic_lognormal")
...
def test_rejects_exponential():
    ...
    result = fit_clauset_powerlaw(samples, name="synthetic_exponential")
