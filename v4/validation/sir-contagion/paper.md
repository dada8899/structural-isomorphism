***REMOVED*** SIR Contagion Universality on 50 Countries of COVID-19 Waves: JHU CSSE 2020-2023, the Pastor-Satorras Sub-Class, and the Seventh LLM-Proposed Universality Class
...
**Date.** 2026-05-13. Version: preprint draft, V4 Layer 5 Phase A2 ***REMOVED***7.
...
***REMOVED******REMOVED******REMOVED*** 2.1 JHU CSSE COVID-19 confirmed-case time series
...
***REMOVED******REMOVED******REMOVED*** 2.2 Country selection
...
***REMOVED******REMOVED******REMOVED*** 2.3 Wave detection
...
***REMOVED******REMOVED******REMOVED*** 3.1 R_0 estimation
...
***REMOVED******REMOVED******REMOVED*** 3.2 Final size
...
***REMOVED******REMOVED******REMOVED*** 3.3 Power-law fit
...
***REMOVED******REMOVED******REMOVED*** 3.4 Bootstrap CI
...
***REMOVED******REMOVED******REMOVED*** 3.5 Universality verdict
...
***REMOVED******REMOVED******REMOVED*** 4.1 R_0 distribution
...
***REMOVED******REMOVED******REMOVED*** 4.2 Final-size power-law fit
...
***REMOVED******REMOVED******REMOVED*** 4.3 Cross-country and cross-wave variation
...
***REMOVED******REMOVED******REMOVED*** 5.1 Within-class universality
...
***REMOVED******REMOVED******REMOVED*** 5.2 Cross-network-topology robustness
...
***REMOVED******REMOVED******REMOVED*** 5.3 The Omicron asymmetry
...
***REMOVED******REMOVED******REMOVED*** 5.4 Reporting-quality artifacts
...
***REMOVED******REMOVED******REMOVED*** 5.5 Comparison to bank failures (Phase 8) and DeFi liquidations (Phase 3)
