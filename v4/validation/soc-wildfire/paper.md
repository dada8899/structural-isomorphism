***REMOVED*** Power-Law Size Distribution and Seasonal Omori Decay in US Wildfires: SOC Pipeline Validation on the NIFC Interagency Fire Perimeter Catalog
...
***REMOVED******REMOVED******REMOVED*** 4.1 Size distribution
...
***REMOVED******REMOVED******REMOVED*** 4.2 Likelihood ratio: lognormal beats power-law
...
***REMOVED******REMOVED******REMOVED*** 4.3 Omori temporal clustering
