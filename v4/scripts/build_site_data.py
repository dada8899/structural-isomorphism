...
CURATED = {
    ...
    ("清算级联的链上流动性危机", "connected_component"): {
        ...
        "predictions": [
            ...
            {
                "target": "Aave V2 DeFi 清算级联 2020-12 → 2024-01 (25,601 stablecoin-debt 事件)",
                "prediction": "清算 USD 规模幂律尾 α = 1.684, 拒绝 lognormal (p = 10⁻²¹), 拒绝 exponential (p = 10⁻⁹³); Omori 1-hour scale p = 0.730 ± 0.043 (227 主震, 6-hour scale 收敛一致 p=0.72)",
                "test_method": "同一 SOC pipeline 第三次交叉验证 — Clauset 2009 power-law on USD sizes + multi-scale Omori (daily/6h/1h) log-linear regression",
                "data_source": "Etherscan V2 API (chainid=1) → Aave V2 LendingPool LiquidationCall 事件日志",
                "sample_size": "28,943 raw events / 25,601 stablecoin-debt / 4,771 tail above $17,494",
                "paper_target": "Layer 5 Phase 3 — 首个 DeFi SOC 定量测量 + 三点跨域验证完整化",
                "status": "✅ 已验证 (2026-04-15)",
                "rationale": "项目首个DeFi SOC 定量测量 — 文献从未发表过. α=1.68 接近地震能量 1.79 而非股市 3.0, 证明 DeFi 清算和地震同属'离散阈值触发' sub-class, 而股市是'连续价格 diffusion'类. 三点跨域 (物理/股市/DeFi) SOC 普适性首次完整化. 论文与 Phase 1/2 互为 companion.",
                "paper_url": "/paper/soc-defi-2026-04-15",
                "paper_title": "First Quantitative Measurement of SOC in DeFi Liquidation Cascades",
            },
        ],
    },
