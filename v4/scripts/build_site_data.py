        ...
        "predictions": [
            {
                ...
                "paper_target": "Layer 5 Phase 1 — pipeline validation",
                "status": "✅ 已验证 (2026-04-15)",
                "rationale": "SOC 普适类的黄金参考. 在真实全球地震数据上完整复现 b ≈ 1 + Omori p ≈ 1. 这验证了分析 pipeline, 为跨域应用 (DeFi / 神经 / 社会) 铺路. 详细报告: v4/validation/soc-earthquake/VERDICT-2026-04-15.md",
            },
            {
                "target": "DeFi 清算级联",
