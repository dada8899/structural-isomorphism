***REMOVED*** Phase Detector — `/company/[ticker]` detail page audit

**Date**: 2026-05-15
**Session**: ***REMOVED***9 Wave 5 sub-agent D
...
***REMOVED******REMOVED*** 1. Context

W4-B (PR ***REMOVED***113) wrapped `CompanyCard` in a `<Link>` so clicking a card navigates to `/company/[ticker]`. W4-B verified the **navigation** part (link target + href). W5-D verifies the **destination** — does the detail page deliver enough value to make the click worth it?
...
***REMOVED******REMOVED*** 2. Fields rendered (现有)
...
***REMOVED******REMOVED*** 3. Fields missing (缺失) — relative to Bloomberg / Yahoo Finance / similar terminals
...
***REMOVED******REMOVED*** 4. Navigation paths
...
***REMOVED******REMOVED*** 5. Mobile visual issues
...
***REMOVED******REMOVED*** 6. Scoring (1-5, 5 = best)
...
***REMOVED******REMOVED*** 7. Comparison with reference terminals
...
***REMOVED******REMOVED*** 8. Changes made in this PR (W5-D-capacity)
...
***REMOVED******REMOVED*** 9. Top 3 improvement suggestions (follow-up — out of W5-D capacity)

***REMOVED******REMOVED******REMOVED*** Suggestion 1 — Surface evidence anchors on the detail page (HIGH ROI)
...
***REMOVED******REMOVED******REMOVED*** Suggestion 2 — Add 1-line peer comparison on the detail page (MEDIUM ROI)
...
***REMOVED******REMOVED******REMOVED*** Suggestion 3 — Mobile chrome fixes (LOW ROI but visible)
...
***REMOVED******REMOVED*** 10. Field comparison table (audit core artifact)
