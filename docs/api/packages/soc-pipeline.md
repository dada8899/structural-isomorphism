...
***REMOVED*** Synthetic Pareto sample
...
***REMOVED******REMOVED*** Top-level entry points

::: soc_pipeline.validate

::: soc_pipeline.Verdict

***REMOVED******REMOVED*** Power-law fit
...
***REMOVED******REMOVED*** Likelihood-ratio test (Vuong)
...
***REMOVED******REMOVED*** Omori-law decay
...
***REMOVED******REMOVED*** Gutenberg-Richter b-value
...
***REMOVED******REMOVED*** Pandas accessor

The package registers a `.soc` accessor on `pandas.Series`:

```python
import pandas as pd
import soc_pipeline  ***REMOVED*** registers .soc accessor as side-effect
