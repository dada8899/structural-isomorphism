***REMOVED*** Full user journey e2e — `test_full_user_journey.py`

**Author:** W14-A sub-agent (session ***REMOVED***10, 2026-05-15)
...
***REMOVED******REMOVED*** Why a single 14-step test, not 14 separate tests
...
***REMOVED******REMOVED*** The 14 steps (with assertion tier)

| ***REMOVED*** | Step | Page | Hard assert |
|---|---|---|---|
...
***REMOVED******REMOVED*** Hard vs soft tier
...
***REMOVED******REMOVED*** Console-error filter
...
***REMOVED******REMOVED*** Results JSON shape
