...
- [x] README rewritten for external audience (W6-E session ***REMOVED***10 — leads with question, 3-card layout, tightened to ~1100 words)
- [ ] All TODO placeholders in `setup.py`, `pyproject.toml`, papers replaced with real values (W6-A handled most; verify before flip)

***REMOVED******REMOVED*** P1 (recommended, not blocking)
...
- [x] universality-classes.json duplicate class_id resolved (commit bfdf2b0 + W6-E session ***REMOVED***10 — `_v2` suffix policy, regression test in `tests/test_universality_classes_unique.py`, decision record in `docs/data/universality-classes-dedupe-2026-05-15.md`)

***REMOVED******REMOVED*** Decision gates (founder authorization required)
...
Last updated: 2026-05-15 (W6-E session ***REMOVED***10 — README rewrite + dedupe regression + React error e2e regression tests landed)
Maintainer: @dada8899
