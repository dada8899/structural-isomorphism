...
***REMOVED******REMOVED*** Quickstart by audience
...
***REMOVED******REMOVED*** Key Results

***REMOVED******REMOVED******REMOVED*** V1 Model (1214 training samples, original 84-type SIBD)
...
***REMOVED******REMOVED******REMOVED*** V2 Model (5689 training samples, expanded 4443-phenomenon KB)
...
***REMOVED******REMOVED******REMOVED*** Three-Pipeline Discovery Results
...
***REMOVED******REMOVED*** Dataset: SIBD-63 (Seed Bank)
...
***REMOVED******REMOVED*** Knowledge Base
...
***REMOVED******REMOVED******REMOVED*** 1. Basic Search
...
***REMOVED*** Describe a phenomenon in natural language
...
***REMOVED******REMOVED******REMOVED*** 2. Cross-domain Inspiration

```python
***REMOVED*** Find structural analogies for a business problem
results = search.query(
...
***REMOVED*** Might return: Braess's Paradox (Traffic), Tragedy of the Commons (Economics),
***REMOVED*** Prisoner's Dilemma (Game Theory) -- all share the structure of
***REMOVED*** "local optimization leading to global suboptimality"
```

***REMOVED******REMOVED******REMOVED*** 3. Scientific Discovery Pipeline
...
***REMOVED*** Find potentially unknown cross-domain connections
...
├── structural_isomorphism/    ***REMOVED*** Python package
│   ├── __init__.py
│   ├── search.py              ***REMOVED*** StructuralSearch main class
│   ├── model.py               ***REMOVED*** Model loading & encoding
│   └── data.py                ***REMOVED*** Data loading utilities
├── data/
│   ├── clean.jsonl            ***REMOVED*** SIBD training data (1,214 entries)
│   ├── kb-science.jsonl       ***REMOVED*** Knowledge base: science (170)
│   ├── kb-social.jsonl        ***REMOVED*** Knowledge base: social (170)
│   └── kb-cross.jsonl         ***REMOVED*** Knowledge base: cross-domain (160)
├── scripts/
│   ├── train.py               ***REMOVED*** Training script
│   ├── evaluate.py            ***REMOVED*** Evaluation script
│   └── v2_pipeline.py         ***REMOVED*** Discovery pipeline
├── demo/
│   └── app.py                 ***REMOVED*** Gradio web demo
├── notebooks/
│   └── quickstart.ipynb       ***REMOVED*** Getting started notebook
├── models/                    ***REMOVED*** Model weights (not in git)
├── results/                   ***REMOVED*** Evaluation results
└── paper/                     ***REMOVED*** Paper drafts
```
