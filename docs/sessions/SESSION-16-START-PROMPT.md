# 起手:structural-isomorphism / M1.4 报告生成器后端

> Session #16 起手 prompt(浓缩版)。完整交接见 `SESSION-15-HANDOFF.md`,事故复盘见 `SESSION-15-INCIDENT-deploy-pipeline.md`,数据 + 决策见 `SESSION-15-VERDICT.md`。

**项目**:`~/Projects/structural-isomorphism/`(repo: `dada8899/structural-isomorphism`, PUBLIC)
**上一 session**:#15。

## 当前 prod 状态(verified 2026-05-20)

- main:`6cf8205`(PR #223 frontend search box)→ `4a8f643`(#225 session-15 hotfix)→ `690c77b`(#224 M1.2/M1.3)
...
**M1.4 目标**(start-prompt 老定义,session #15 verdict 确认):
...
- `docs/sessions/SESSION-15-HANDOFF.md` — 完整 session #15 交接
