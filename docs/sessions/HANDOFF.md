...
读完这 5 个文件即可上手：
1. **本文件** (HANDOFF.md)
2. **`docs/sessions/SESSION-4-STARTER.md`** — 🔥 session ***REMOVED***4 直接执行清单（全权授权 token-blocked actions runbook）
3. `docs/sessions/structural-iso-session-3-end.md` — session ***REMOVED***3 retro (latest)
4. `paper/v0-unified-pipeline-2026-05-13.md` v0.3 — C1 unified preprint (latest)
5. `CLAUDE.md` (repo root) — 项目级 CC 指引

---

***REMOVED******REMOVED*** 1. 当前状态 (2026-05-13 session ***REMOVED***3 截止)
