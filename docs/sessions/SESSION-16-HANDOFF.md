...
**Outcome**: 12 commits to main, 374/374 backend tests green, M1.4 backend slice (PR ***REMOVED***1-4) shippable.
...
***REMOVED******REMOVED******REMOVED*** 2.2 PR ***REMOVED***5 (next CC session)

Frontend integration. Spec ready in `docs/sessions/M1.4-frontend-integration-guide.md`. Estimated < 1 day.

***REMOVED******REMOVED******REMOVED*** 2.3 Validator P2 items (deferred, none ship-blocking)
