***REMOVED*** Mobile Design System — Phase Detector

**Status:** v1 baseline shipped in W12-C (session ***REMOVED***10, 2026-05-15).
...
***REMOVED******REMOVED*** 1. Touch targets
...
***REMOVED******REMOVED******REMOVED*** How to comply
...
***REMOVED******REMOVED******REMOVED*** Common offenders (audited W12-C)
...
***REMOVED******REMOVED*** 2. Safe-area handling (iOS notch / Dynamic Island / home indicator)
...
***REMOVED******REMOVED*** 3. Scroll behavior

***REMOVED******REMOVED******REMOVED*** Smooth anchor scrolling

`html { scroll-behavior: smooth; }` in `globals.css`. Wrapped in
`@media (prefers-reduced-motion: reduce)` to honor user preference.

***REMOVED******REMOVED******REMOVED*** Sticky-nav slide pattern
...
***REMOVED******REMOVED******REMOVED*** Wide tables on mobile
...
***REMOVED******REMOVED******REMOVED*** Vocabulary
...
***REMOVED******REMOVED******REMOVED*** Thresholds (defaults)
...
***REMOVED******REMOVED*** 6. Breakpoints (Tailwind)
...
***REMOVED******REMOVED******REMOVED*** Multi-column layouts
...
***REMOVED******REMOVED*** 7. Mobile-first visualizations
...
***REMOVED******REMOVED*** 9. Reduced motion
...
***REMOVED******REMOVED*** 11. Changelog

| Date | Session | Author | Change |
|---|---|---|---|
| 2026-05-15 | ***REMOVED***10 W12-C | sub-agent C | v1 baseline: touch targets, safe-area, swipe nav, smooth scroll, pinch-zoom, slide-on-scroll header, mobile-visual regression suite |
