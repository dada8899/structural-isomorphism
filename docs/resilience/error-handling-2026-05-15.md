***REMOVED*** Error handling, offline mode, and incident reporting (W12-E)
...
***REMOVED******REMOVED*** 1. Error-boundary hierarchy
...
***REMOVED******REMOVED*** 2. Service-worker caching strategy
...
***REMOVED******REMOVED******REMOVED*** Offline fallback
...
***REMOVED******REMOVED*** 3. Error reporting privacy
...
***REMOVED******REMOVED*** 4. Rate limiting + rotation
...
***REMOVED******REMOVED*** 5. Debugging a reported error
...
***REMOVED******REMOVED*** 6. Deferred work
