***REMOVED*** arXiv Submission Runbook — 6 papers, structural-isomorphism v0.3
...
***REMOVED******REMOVED*** Pre-requisites (one-time)

***REMOVED******REMOVED******REMOVED*** 1. arXiv account
...
***REMOVED******REMOVED******REMOVED*** 2. Endorsement (for first-time submitters in some categories)
...
***REMOVED******REMOVED******REMOVED*** 3. Pre-submission file prep (ALREADY DONE)
...
***REMOVED******REMOVED******REMOVED*** 4. Replace author placeholders
...
***REMOVED******REMOVED*** Submission workflow (per paper)

For each of the 6 PDFs, in order (C1 first, then 01-04, then C4):

***REMOVED******REMOVED******REMOVED*** Step 1 — Start new submission
...
***REMOVED******REMOVED******REMOVED*** Step 2 — Upload file
...
***REMOVED******REMOVED******REMOVED*** Step 3 — Metadata
...
***REMOVED******REMOVED******REMOVED*** Step 4 — Preview
...
***REMOVED******REMOVED******REMOVED*** Step 5 — Submit
...
***REMOVED******REMOVED******REMOVED*** Step 6 — Post-publication
...
***REMOVED******REMOVED*** Submission timing strategy
...
***REMOVED******REMOVED*** Optional: PDF rebuild with xelatex (higher quality)
...
***REMOVED*** Refresh PATH then install required packages
...
***REMOVED******REMOVED*** Future: companion paper revisions
...
***REMOVED******REMOVED*** Withdrawal (rare; only if you regret submission)
