...
***REMOVED******REMOVED*** Prerequisites (one-time)
...
***REMOVED******REMOVED*** Step 1 — TestPyPI dry-run (recommended)

```bash
cd ~/Projects/structural-isomorphism
source ~/.config/secrets/pypi.env   ***REMOVED*** loads TESTPYPI_TOKEN + PYPI_TOKEN
...
***REMOVED******REMOVED*** Step 2 — Production PyPI
...
***REMOVED******REMOVED*** Step 3 — Version bump for next release
...
***REMOVED******REMOVED*** Step 4 — Post-publish announce
