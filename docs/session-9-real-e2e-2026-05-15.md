***REMOVED*** Session ***REMOVED***9 Wave 3-A — Real user flow e2e + CLS (2026-05-15)
...
***REMOVED******REMOVED*** Per-flow results

***REMOVED******REMOVED******REMOVED*** Flow 1 — beta home → search → answer → followup
...
***REMOVED******REMOVED******REMOVED*** Flow 2 — /classes → click first card → phenomenon view
...
***REMOVED******REMOVED******REMOVED*** Flow 3 — phase home → company → backtest
- **Desktop / Mobile**: both pass.
...
***REMOVED******REMOVED******REMOVED*** Flow 4 — newsletter signup at /start-here
- **Desktop / Mobile**: both pass.
- Newsletter form mounted (***REMOVED***newsletter-start-here), email filled, submit clicked.
...
***REMOVED******REMOVED*** CLS measurements
...
***REMOVED******REMOVED******REMOVED*** W1-E status (CLS fix on /discoveries)
...
***REMOVED******REMOVED*** Anomalies (sub-agent dispatch)
...
***REMOVED******REMOVED*** Files produced
