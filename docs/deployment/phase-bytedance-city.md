***REMOVED*** Deployment: phase.bytedance.city (D1 Phase Detector)

Deployed 2026-05-13 (W4-D, v4 session ***REMOVED***3).
...
***REMOVED******REMOVED*** Port allocation
...
***REMOVED*** 3. restart API (picks up new DB rows since stateless reads)
ssh root@43.156.233.71 'systemctl restart phase-detector-api'

***REMOVED*** 4. (optional) verify
...
***REMOVED******REMOVED*** Monitoring TODO
...
***REMOVED******REMOVED*** Known gaps / follow-ups
