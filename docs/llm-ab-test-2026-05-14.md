***REMOVED*** LLM AB Test — `/api/ask/stream` Sonnet 4.6 vs DeepSeek Chat

**Date**: 2026-05-14
**Session**: ***REMOVED***8 (session8/w2e-vps-llm)
**Tester**: Local CC
...
***REMOVED******REMOVED*** Test Methodology
...
***REMOVED******REMOVED*** Qualitative

***REMOVED******REMOVED******REMOVED*** Q1 — "What is self-organized criticality and where does it appear in nature?"
...
***REMOVED******REMOVED******REMOVED*** Q2 — "How does the BTW sandpile model show power-law avalanches?"
...
***REMOVED******REMOVED******REMOVED*** Q3 — "为什么基于幂律分布的critical point判定在金融市场容易失效?"
...
***REMOVED******REMOVED*** Recommendation: **KEEP** (with tier-aware safeguard for scale)
