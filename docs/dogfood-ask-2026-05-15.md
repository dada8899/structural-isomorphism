***REMOVED*** LLM /api/ask/stream 真实质量评估报告

> Session ***REMOVED***9 Wave 4 sub-agent D — 2026-05-15
...
***REMOVED******REMOVED*** 逐 query 评分

***REMOVED******REMOVED******REMOVED*** q1 - cross-domain :: 为什么硅谷银行挤兑后市场反应这么剧烈？还有哪些类似的级联系统？
...
***REMOVED******REMOVED******REMOVED*** q2 - cross-domain :: 团队氛围崩了之后为什么很难恢复？跟相变有关系吗？
...
***REMOVED******REMOVED******REMOVED*** q3 - business :: 月活用户每月按固定比率掉 7%，怎么看怎么干预？
...
***REMOVED******REMOVED******REMOVED*** q4 - business :: 为什么有些谣言会爆，另一些悄悄消散？区别在哪？
...
***REMOVED******REMOVED******REMOVED*** q5 - edge-irrelevant :: 我女朋友为什么生气了？
...
***REMOVED******REMOVED******REMOVED*** q6 - edge-trivial :: 求 1+1 = ?
...
***REMOVED******REMOVED******REMOVED*** q7 - edge-prediction :: Bitcoin 明天涨还是跌？
...
***REMOVED******REMOVED*** 5 个最严重 Issue（按优先级）

***REMOVED******REMOVED******REMOVED*** P0 — 边缘 query 全部硬答，无 out-of-scope 机制
...
***REMOVED******REMOVED******REMOVED*** P1 — 首 answer_chunk 延迟 18-32s（用户视角崩溃点）
...
***REMOVED******REMOVED******REMOVED*** P2 — q2 团队氛围 retrieval 顶部命中"形状记忆合金"（关键词 hack，score=1.0 明显异常）
...
***REMOVED******REMOVED******REMOVED*** P3 — q6 trivial query 反而最慢（33.26s）
...
***REMOVED******REMOVED******REMOVED*** P4 — Citations `[1]-[5]` 引用规范但未在前端做对应
...
***REMOVED******REMOVED*** Anomaly / 数据说明

- 7/7 query 全部 HTTP 200，没遇到 rate limit（运行时插了 2s sleep 缓冲，匿名 quota 5/min 没撞）
- 部署的 prod 模型是 `anthropic/claude-sonnet-4.6`（与 W2-E session ***REMOVED***8 升级一致，没漂回旧模型）
