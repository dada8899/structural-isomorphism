***REMOVED*** W5-F Copywriter Review — narrative / voice / clarity
...
***REMOVED******REMOVED*** 2. Audience confusion（最大问题）
...
***REMOVED******REMOVED*** 3. Phase Detector（phase.）文案 review

***REMOVED******REMOVED******REMOVED*** 3.1 Hero copy
...
***REMOVED******REMOVED******REMOVED*** 3.2 Filter labels
...
***REMOVED******REMOVED******REMOVED*** 3.3 Card TL;DR 文案
...
***REMOVED******REMOVED******REMOVED*** 3.4 Caveats / disclaimer
...
***REMOVED******REMOVED*** 4. structural.bytedance.city 主站文案

***REMOVED******REMOVED******REMOVED*** 4.1 Home hero
...
***REMOVED******REMOVED******REMOVED*** 4.2 Classes 页文案
...
***REMOVED******REMOVED******REMOVED*** 4.3 Methods 页文案
...
***REMOVED******REMOVED******REMOVED*** 4.4 Papers 列表页
...
***REMOVED******REMOVED******REMOVED*** 4.5 Taxonomy-v2 verdict 页
...
***REMOVED******REMOVED*** 5. Paper 写作风格

***REMOVED******REMOVED******REMOVED*** 5.1 C1 v0.2 unified preprint
...
***REMOVED******REMOVED******REMOVED*** 5.2 C2 4 solo drafts abstract 优劣排序
...
***REMOVED******REMOVED******REMOVED*** 5.3 C4 red-team paper
...
***REMOVED******REMOVED*** 6. Tutorial 文案

***REMOVED******REMOVED******REMOVED*** 6.1 README
...
***REMOVED******REMOVED******REMOVED*** 6.2 Notebook markdown cells
...
***REMOVED******REMOVED*** 7. AI-flavored prose 检测（具体引用）
...
***REMOVED******REMOVED*** 9. 90 分文案标准（gap list）
...
***REMOVED******REMOVED*** 10. 7-day quick wins（10+ 条 1-2 小时内能改）
...
***REMOVED******REMOVED*** 11. 30-day content strategy

***REMOVED******REMOVED******REMOVED*** Stories 可孵化
...
***REMOVED******REMOVED******REMOVED*** 学界 outreach email 模板
...
***REMOVED******REMOVED******REMOVED*** 投资人 / 媒体 pitch deck outline
...
***REMOVED******REMOVED*** 12. Final scores
