...
class AskOrchestrator:
    ...
    ***REMOVED*** ------------------------------------------------------------------ ***REMOVED***
    ...
    async def stream(self, query: str, lang: str = "zh") -> AsyncIterator[str]:
        ...
        ***REMOVED*** Typewriter-emit the answer text.
        ...
        if answer_text:
            for chunk in self._typewriter_chunks(answer_text):
                ...
                ***REMOVED*** Yield control between chunks so other awaits (search,
                ***REMOVED*** heartbeats) can run. Skip the sleep when running in
                ***REMOVED*** tests to keep test runtime tight.
