...
**Date.** 2026-05-13. Version: v0.2 (session ***REMOVED***3) preprint draft.
...
***REMOVED******REMOVED******REMOVED*** 4.4 Shape-normalized collapse ratio — the headline number
...
***REMOVED******REMOVED******REMOVED*** 4.5 Bayesian model selection across PL / PL+cutoff / LN — first positive evidence for universality class
