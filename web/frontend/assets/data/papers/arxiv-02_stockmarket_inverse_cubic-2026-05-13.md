***REMOVED*** Cross-Domain Self-Organized Criticality: Inverse Cubic Law and Omori Decay on Thirty-Five Years of S&P 500 Daily Returns
...
***REMOVED******REMOVED******REMOVED*** 2.3 Omori-Utsu aftershock stacking
...
***REMOVED******REMOVED******REMOVED*** 3.3 Robustness: threshold sensitivity
...
***REMOVED******REMOVED******REMOVED*** 3.4 Joint comparison with Phase 1
...
***REMOVED******REMOVED******REMOVED*** 4.3 Practical implications
...
```
python3 fetch_and_analyze.py    ***REMOVED*** full pipeline (fetch + G-R + Omori), ~30 s
```
