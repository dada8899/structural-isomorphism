***REMOVED*** SOC Universality on 92 Years of U.S. Bank Failures: FDIC 1934-2026, the Diamond-Dybvig Sub-Class, and the Seventh Verified System
...
***REMOVED******REMOVED******REMOVED*** 2.1 FDIC bank failure record
...
***REMOVED******REMOVED******REMOVED*** 2.2 Decade distribution
...
***REMOVED******REMOVED******REMOVED*** 2.3 Why FDIC
...
***REMOVED******REMOVED******REMOVED*** 3.1 Power-law fit
...
***REMOVED******REMOVED******REMOVED*** 3.2 Bootstrap
...
***REMOVED******REMOVED******REMOVED*** 3.3 Era split
...
***REMOVED******REMOVED******REMOVED*** 3.4 Omori-Utsu temporal stack
...
***REMOVED******REMOVED******REMOVED*** 3.5 Matched-$n$ null control
...
***REMOVED******REMOVED******REMOVED*** 4.1 Whole-period power-law fit
...
***REMOVED******REMOVED******REMOVED*** 4.2 Era split
...
***REMOVED******REMOVED******REMOVED*** 4.3 Omori-Utsu: temporal decay absent
...
***REMOVED******REMOVED******REMOVED*** 5.1 Position in the V4 class
...
***REMOVED******REMOVED******REMOVED*** 5.2 Cross-temporal universality vs DeFi
...
***REMOVED******REMOVED******REMOVED*** 5.3 Contrast with earthquakes (L00)
...
***REMOVED******REMOVED******REMOVED*** 5.4 First-principles partial check
...
***REMOVED******REMOVED******REMOVED*** 5.5 Lognormal-vs-power-law inconclusiveness
