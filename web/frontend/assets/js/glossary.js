...
(function () {
  ...
  const GLOSSARY = {
    ...
    '幂律分布': '少数事件极大、多数事件极小的那种典型分布。地震、城市人口、财富分配都接近幂律——绝大多数很小，但偶尔出现极端大的。',
    '幂律': '少数事件极大、多数事件极小的那种典型规律，写成 y ~ x^(-α)。',
    '自组织临界': '系统会自己滑到「一点就炸」的临界边缘，不需要外部精确调参。一堆沙子不断加沙会自己维持在随时可能崩塌的状态。',
    '结构同构': '两个看似无关的现象，在数学结构层面其实是同一回事——共用同一套方程和变量关系。',
