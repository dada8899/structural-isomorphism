...
(function () {
  ...
  var css =
    ...
    '.product-switcher__seg{padding:5px 12px;border-radius:999px;color:***REMOVED***52525B;text-decoration:none;transition:all .15s;white-space:nowrap;font-weight:500;font-family:inherit}' +
    '.product-switcher__seg:hover{color:***REMOVED***18181B;text-decoration:none}' +
    '.product-switcher__seg--active{background:***REMOVED***FFFFFF;color:***REMOVED***2563EB;box-shadow:0 1px 2px rgba(0,0,0,0.06);border:1px solid rgba(37,99,235,0.18)}' +
