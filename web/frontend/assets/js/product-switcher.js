...
(function () {
  ...
  var css =
    ...
    '.brand-back-link{' +
    '  font-size:13px;color:***REMOVED***71717A;text-decoration:none;font-weight:500;' +
    '  padding:5px 10px;border-radius:6px;transition:all .15s;white-space:nowrap;' +
    '  font-family:Inter,-apple-system,system-ui,sans-serif;' +
    '}' +
    '.brand-back-link:hover{color:***REMOVED***2563EB;background:rgba(37,99,235,0.08);text-decoration:none}' +
    '.brand-back-sep{color:***REMOVED***D4D4D8;font-weight:300;font-size:18px;user-select:none}' +
