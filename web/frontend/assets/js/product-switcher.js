...
(function () {
  ...
  var css = [
    ...
    '  border-radius:8px;',
    '  color:***REMOVED***18181B;text-decoration:none !important;',
    ...
    '}',
    '.parent-brand:hover{',
    '  background:***REMOVED***EFF6FF;',
    '  color:***REMOVED***1E40AF;',
    '  transform:translateX(-2px);',
    '}',
    '.parent-brand__icon{',
    '  width:22px;height:22px;color:***REMOVED***2563EB;flex-shrink:0;',
    '}',
    '.parent-brand__text{font-weight:600}',
    '.parent-brand__beta{',
    '  font-size:9.5px;padding:2px 6px;',
    '  background:rgba(37,99,235,0.10);color:***REMOVED***2563EB;',
    ...
    /* hover 时显示小箭头表示可点击 */
    '.parent-brand__arrow{',
    '  font-size:13px;font-weight:600;color:***REMOVED***2563EB;',
    ...
    '  color:***REMOVED***CBD5E1;font-size:14px;line-height:1;',
    '  font-weight:400;',
    '}',
    '.sub-product-label__badge{',
    '  display:inline-flex;',
    '  padding:1.5px 7px;',
    '  background:linear-gradient(135deg,***REMOVED***2563EB,***REMOVED***1D4ED8);',
    ...
    '  font-weight:500;color:***REMOVED***52525B;',
    '}',
    '.sub-product-label__beta{',
    '  font-size:9px;padding:1px 4px;',
    '  background:***REMOVED***F4F4F5;color:***REMOVED***A1A1AA;',
