      ...
      >
        ...
        >
          ...
          {nodes.map((n, i) => {
            ...
            const fill = n.isCenter ? "***REMOVED***18181B" : DOMAIN_COLOR[n.domain] ?? "***REMOVED***71717A";
            return (
              <g
                key={n.id}
                data-testid={
              ...
              >
                ...
                <text
                  ...
                  fill={n.isCenter ? "white" : "***REMOVED***27272A"}
                  textAnchor="middle"
        ...
        {hover !== null && !nodes[hover].isCenter && (
          ...
          >
            <div style={{ fontWeight: 600, color: "***REMOVED***18181B" }}>
              {nodes[hover].label}
            </div>
            <div style={{ color: "***REMOVED***52525B", fontSize: 11, marginTop: 2 }}>
              领域 · {DOMAIN_LABEL_ZH[nodes[hover].domain] ?? nodes[hover].domain}
            </div>
            {nodes[hover].verdict && (
              <div style={{ color: "***REMOVED***52525B", fontSize: 11 }}>
