    ...
    <main className="mx-auto max-w-2xl px-6 py-20" data-testid="not-found-page">
      ...
      <div className="flex flex-wrap items-center gap-3">
        <Link
          ...
          className="inline-flex min-h-11 items-center rounded-md bg-zinc-900 px-4 py-2 text-sm font-medium text-white transition hover:bg-zinc-800 dark:bg-zinc-100 dark:text-zinc-900 dark:hover:bg-white"
        >
          回到首页
        </Link>
        <button
