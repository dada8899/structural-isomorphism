...
// W3-B (session ***REMOVED***9, 2026-05-14): self-host fonts via next/font (latin subset only).
...
export default function RootLayout({
  ...
  return (
    ...
    >
      <body className="min-h-screen bg-[***REMOVED***F5F5F4] font-sans text-zinc-900 antialiased lg:pl-60 safe-area-body">
        ...
        <OnboardingTour />
        {/* W13-E (session ***REMOVED***10) Cmd+K command palette — global mount + keyboard shortcut. */}
