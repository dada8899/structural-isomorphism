// Session ***REMOVED***12 W17 experiment — "Insight Cases" path C MVP.
//
...
/**
 * The synthesis block — the *answer-shaped* output added in session ***REMOVED***12 W17
...
export interface InsightCase {
  ...
  /** The answer-shaped synthesis block (session ***REMOVED***12 W17). */
