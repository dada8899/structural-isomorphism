...
Session ***REMOVED***12 (W16 pre-launch audit) flipped the positioning from "Daily
...
def test_hero_headline_renders(page):
    ...
    Session ***REMOVED***12 (W16 pre-launch audit) flipped the headline from
...
def test_two_hero_ctas_work(page):
    ...
    Session ***REMOVED***12 (W16 audit) demoted the tertiary "v0.1 NULL backtest"
    text-link out of the hero and changed the secondary CTA from the
    ***REMOVED***how-it-works in-page anchor to /methodology so researchers landing
    ...
    ***REMOVED*** Secondary destination (full page)
...
def test_trust_signals_present(page):
    ...
    Session ***REMOVED***12 (W16 audit) renamed the eyebrow "Receipts · 凭证" →
