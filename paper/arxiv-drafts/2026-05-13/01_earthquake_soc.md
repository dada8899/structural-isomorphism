***REMOVED*** Recovering Self-Organized Criticality on a Global Earthquake Catalog: A Reproducible Pipeline for Cross-Domain Universality-Class Identification
...
***REMOVED******REMOVED******REMOVED*** 2.1 Earthquake catalog
...
***REMOVED******REMOVED******REMOVED*** 2.2 Magnitude of completeness
...
***REMOVED******REMOVED******REMOVED*** 2.3 Maximum-likelihood $b$-value and its uncertainty
...
***REMOVED******REMOVED******REMOVED*** 2.4 Bootstrap confidence interval
...
***REMOVED******REMOVED******REMOVED*** 2.5 Clauset-Shalizi-Newman cross-check on energies
...
***REMOVED******REMOVED******REMOVED*** 2.6 Omori-Utsu aftershock stacking
...
***REMOVED******REMOVED******REMOVED*** 2.7 Statistical controls
...
***REMOVED******REMOVED******REMOVED*** 3.1 Gutenberg-Richter
...
***REMOVED******REMOVED******REMOVED*** 3.2 Omori-Utsu aftershock decay
...
***REMOVED******REMOVED******REMOVED*** 3.3 Robustness: power-law versus lognormal
...
***REMOVED******REMOVED******REMOVED*** 3.4 Robustness: $x_\mathrm{min}$ sensitivity
...
***REMOVED******REMOVED******REMOVED*** 4.1 Comparison to prediction bands
...
***REMOVED******REMOVED******REMOVED*** 4.2 Universality-class assignment
...
***REMOVED******REMOVED******REMOVED*** 4.3 Broader implication
...
```
python3 fetch_earthquakes.py    ***REMOVED*** USGS FDSN API fetch, 3-5 min
python3 gutenberg_richter.py    ***REMOVED*** MLE + bootstrap + Clauset, ~1 min
python3 omori_decay.py          ***REMOVED*** aftershock stacking + log-linear fit, ~10 s
```
