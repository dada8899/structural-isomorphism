***REMOVED*** 超越语义相似度：基于对比学习的跨领域结构同构检测
...
***REMOVED******REMOVED*** 2 相关工作

***REMOVED******REMOVED******REMOVED*** 2.1 类比推理与结构映射
...
***REMOVED******REMOVED******REMOVED*** 2.2 人工智能辅助科学发现
...
***REMOVED******REMOVED******REMOVED*** 2.3 句子嵌入与对比学习
...
***REMOVED******REMOVED******REMOVED*** 2.4 跨领域知识迁移
...
***REMOVED******REMOVED*** 3 结构同构基准数据集（SIBD）

***REMOVED******REMOVED******REMOVED*** 3.1 分类体系设计
...
***REMOVED******REMOVED******REMOVED*** 3.2 数据生成与质量控制
...
***REMOVED******REMOVED******REMOVED*** 3.3 数据集统计与分析
...
***REMOVED******REMOVED*** 4 方法

***REMOVED******REMOVED******REMOVED*** 4.1 问题形式化
...
***REMOVED******REMOVED******REMOVED*** 4.2 对比训练
...
***REMOVED******REMOVED******REMOVED*** 4.3 六种阻断机制作为后处理过滤器
...
***REMOVED******REMOVED******REMOVED*** 4.4 与第一性原理思维的关系
...
***REMOVED******REMOVED******REMOVED*** 4.5 V3 管线：StructTuple + LLM 配对重排序
...
***REMOVED******REMOVED*** 5 实验

***REMOVED******REMOVED******REMOVED*** 5.1 实验设置
...
***REMOVED******REMOVED******REMOVED*** 5.2 主要结果
...
***REMOVED******REMOVED******REMOVED*** 5.3 案例分析
...
***REMOVED******REMOVED******REMOVED*** 5.4 对照实验
...
***REMOVED******REMOVED******REMOVED*** 5.5 消融实验
...
***REMOVED******REMOVED*** 6 应用：发现未知的跨领域联系

***REMOVED******REMOVED******REMOVED*** 6.1 知识库构建
...
***REMOVED******REMOVED******REMOVED*** 6.2 发现管线
...
***REMOVED******REMOVED******REMOVED*** 6.3 结果汇总
...
***REMOVED******REMOVED******REMOVED*** 6.4 案例展示：三项典型发现
...
***REMOVED******REMOVED******REMOVED*** 6.5 V3 实验结果：规模化的 StructTuple + LLM 重排序
...
***REMOVED******REMOVED******REMOVED*** 7.2 框架修正：约 60% 覆盖率，而非普适理论
...
***REMOVED******REMOVED*** 8 讨论

***REMOVED******REMOVED******REMOVED*** 8.1 对 AI 辅助科学发现的启示
...
***REMOVED******REMOVED******REMOVED*** 8.2 "影子模式"愿景
...
***REMOVED******REMOVED******REMOVED*** 8.3 与第一性原理思维的关系
...
***REMOVED******REMOVED******REMOVED*** 8.4 更广泛的启示与未来方向
...
***REMOVED******REMOVED*** 附录 A：84 种结构类型完整分类
