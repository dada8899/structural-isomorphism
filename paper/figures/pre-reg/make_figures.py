...
def render_case(case: dict) -> None:
    ...
    ***REMOVED*** Empirical CCDF
    mask_pos = (cc > 0) & (grid > 0)
    ax.plot(
        grid[mask_pos], cc[mask_pos],
        "o", color="***REMOVED***1f77b4", markersize=3.5, alpha=0.7,
        label="empirical CCDF", zorder=2,
    )

    ***REMOVED*** Pre-registered band — shaded envelope of slopes
    ...
    if xmin is not None and xmin > 0:
        ...
        ***REMOVED*** CCDF at xmin (from empirical)
        try:
