***REMOVED*** arXiv Submission Metadata
...
***REMOVED******REMOVED*** Paper 1 — `c1-unified-v0.3.pdf`
...
***REMOVED******REMOVED*** Paper 2 — `01_earthquake_soc.pdf`
...
***REMOVED******REMOVED*** Paper 3 — `02_stockmarket_inverse_cubic.pdf`
...
***REMOVED******REMOVED*** Paper 4 — `03_defi_cross_protocol.pdf`
...
***REMOVED******REMOVED*** Paper 5 — `04_neural_avalanches.pdf`
...
***REMOVED******REMOVED*** Paper 6 — `c4-reject-aware.pdf`
...
***REMOVED******REMOVED*** Submission order (recommended)
...
***REMOVED******REMOVED*** Pre-submission checklist (per paper)
