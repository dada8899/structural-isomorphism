***REMOVED*** A pipeline for cross-domain validation of self-organized criticality and preferential attachment: nine systems, one method
...
***REMOVED******REMOVED******REMOVED*** 2.6 Implementation and provenance
...
***REMOVED******REMOVED*** 3. Case studies — nine systems
...
***REMOVED******REMOVED*** 4. Universal collapse
...
***REMOVED******REMOVED******REMOVED*** 4.2 Seven-system rescaled CCDF
...
***REMOVED******REMOVED******REMOVED*** 4.3 Strict-vs-functional collapse
...
***REMOVED******REMOVED******REMOVED*** 4.4 Interpretation
...
***REMOVED******REMOVED*** 5. Taxonomy critic pass (B1) and prediction calibration (B2)
...
***REMOVED******REMOVED******REMOVED*** 5.4 Reverse calibration on nine verified systems
...
***REMOVED******REMOVED******REMOVED*** 6.1 What the nine systems actually buy us
...
***REMOVED******REMOVED******REMOVED*** 6.2 Honest accounting: lognormal is not rejected in three of nine systems
...
***REMOVED******REMOVED******REMOVED*** 6.4 Limitations
...
***REMOVED******REMOVED******REMOVED*** 6.5 Future work
