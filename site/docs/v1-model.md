...
***REMOVED******REMOVED******REMOVED*** 对比学习（Contrastive Learning）
...
```python
EPOCHS = 10
BATCH_SIZE = 16      ***REMOVED*** MPS 内存限制
SEED = 42
BASE_MODEL = "shibing624/text2vec-base-chinese"
```

***REMOVED******REMOVED******REMOVED*** 训练数据加载

```python
***REMOVED*** Build positive pairs from same-type descriptions
