...
***REMOVED*** Higher threshold since we have more data
SIMILARITY_THRESHOLD = 0.70
TOP_N_OUTPUT = 5000  ***REMOVED*** Output top 5000 for screening
...
def main():
    ...
    ***REMOVED*** Compute all pairwise similarities in chunks to save memory
    print("\nComputing pairwise similarities...")
    start = time.time()
    n = len(kb)
    pairs = []

    ***REMOVED*** Process in chunks
    chunk_size = 500
    ...
    for chunk_i in range(total_chunks):
        ...
        ***REMOVED*** Compute sim with ALL items (including self)
