...
***REMOVED*** Publish soc-pipeline + guarded-llm to PyPI (1-click)
***REMOVED***
***REMOVED*** Requires: PYPI_TOKEN env var (project-scoped recommended)
***REMOVED*** Usage:
***REMOVED***   PYPI_TOKEN=pypi-xxx bash scripts/release/publish_pypi.sh
***REMOVED***   ***REMOVED*** Optional dry-run to TestPyPI first:
***REMOVED***   TESTPYPI_TOKEN=pypi-xxx bash scripts/release/publish_pypi.sh --test
***REMOVED***
***REMOVED*** Token format: pypi-AgEIcHlwaS5vcmcCJ...
***REMOVED*** Get one at https://pypi.org/manage/account/token/
...
***REMOVED*** Verify wheels exist; if not, build them
...
***REMOVED*** Twine check before upload
