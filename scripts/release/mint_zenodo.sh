...
***REMOVED*** Mint Zenodo DOI for dataset/v1/ bundle (1-click, NOT auto-publish)
***REMOVED***
***REMOVED*** Requires: ZENODO_ACCESS_TOKEN env var
***REMOVED*** Usage:
***REMOVED***   ZENODO_ACCESS_TOKEN=xxx bash scripts/release/mint_zenodo.sh
***REMOVED***   ***REMOVED*** Optional sandbox dry-run:
***REMOVED***   ZENODO_ACCESS_TOKEN=xxx ZENODO_SANDBOX=1 bash scripts/release/mint_zenodo.sh
***REMOVED***
***REMOVED*** Get personal access token at https://zenodo.org/account/settings/applications/tokens/new/
***REMOVED*** Scopes required: deposit:write, deposit:actions
...
***REMOVED*** Step 2: Create deposition
echo ""
...
***REMOVED*** Step 4: Attach metadata
echo ""
...
***REMOVED*** Step 5: Print review URL — NOT auto-publish
echo ""
echo "========================================================"
