***REMOVED*** Teaching a Neural Network to See Mathematical Skeletons: A Search Engine for Cross-Domain Structural Isomorphism

***REMOVED******REMOVED*** The Question That Started Everything
...
***REMOVED******REMOVED******REMOVED*** Building the Taxonomy
...
***REMOVED******REMOVED******REMOVED*** Generating Training Data
...
***REMOVED******REMOVED******REMOVED*** Fine-Tuning the Embedding Model
...
***REMOVED******REMOVED******REMOVED*** Evaluation
...
***REMOVED******REMOVED*** The Discovery Pipeline
...
***REMOVED******REMOVED*** Three Discoveries That Surprised Us

***REMOVED******REMOVED******REMOVED*** 1. Preisach Hysteresis Maps onto Ecological Regime Shifts
...
***REMOVED******REMOVED******REMOVED*** 2. Urban Innovation Follows an Arrhenius Equation
...
***REMOVED******REMOVED******REMOVED*** 3. DeFi Liquidation Cascades as Elastic Collisions
...
***REMOVED******REMOVED*** What We Learned
