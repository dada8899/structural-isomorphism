...
***REMOVED*** structural-isomorphism/structural-v1
...
***REMOVED******REMOVED*** Model Description
...
***REMOVED******REMOVED*** Evaluation Results
...
***REMOVED******REMOVED******REMOVED*** With sentence-transformers
...
***REMOVED*** Encode two descriptions from different domains
...
***REMOVED*** Both are negative feedback loops -> high similarity
```

***REMOVED******REMOVED******REMOVED*** With the search engine
