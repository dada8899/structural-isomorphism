...
def test_omori_p_recovers_synthetic():
    ...
    ***REMOVED*** Clip to the fit window so we only keep samples the fitter will use
    ...
    ***REMOVED*** Recovery within ±0.3 of true is acceptable for this synthetic + bin scheme
...
def test_bin_and_omori_event_stream():
    ...
    ***REMOVED*** Background Poisson + 20 main shocks each spawning bursts
    ...
    assert isinstance(result, OmoriResult)
    ***REMOVED*** At minimum the detector found main shocks
