...
***REMOVED*** -----------------------------------------------------------------------
***REMOVED*** 1. Valid input → parse success
***REMOVED*** -----------------------------------------------------------------------
...
***REMOVED*** -----------------------------------------------------------------------
***REMOVED*** 8. Invalid verdict value
***REMOVED*** -----------------------------------------------------------------------
...
***REMOVED*** -----------------------------------------------------------------------
***REMOVED*** 9. Missing required field
***REMOVED*** -----------------------------------------------------------------------
...
***REMOVED*** -----------------------------------------------------------------------
***REMOVED*** 11. Retry exhausted (legacy API)
***REMOVED*** -----------------------------------------------------------------------
...
***REMOVED*** -----------------------------------------------------------------------
***REMOVED*** 12. First attempt fails, second passes (legacy API)
***REMOVED*** -----------------------------------------------------------------------
...
***REMOVED*** -----------------------------------------------------------------------
***REMOVED*** 13. Idempotent on clean
***REMOVED*** -----------------------------------------------------------------------
...
***REMOVED*** -----------------------------------------------------------------------
***REMOVED*** 14. llm_caller raises (legacy)
***REMOVED*** -----------------------------------------------------------------------
...
***REMOVED*** -----------------------------------------------------------------------
***REMOVED*** 16. GuardrailResult shape (new API)
***REMOVED*** -----------------------------------------------------------------------
...
***REMOVED*** -----------------------------------------------------------------------
***REMOVED*** 17. Legacy call validates input
***REMOVED*** -----------------------------------------------------------------------
...
***REMOVED*** -----------------------------------------------------------------------
***REMOVED*** 18. Max retries < 1 (legacy)
***REMOVED*** -----------------------------------------------------------------------
...
***REMOVED*** -----------------------------------------------------------------------
***REMOVED*** 20. Empty raw input fails gracefully
***REMOVED*** -----------------------------------------------------------------------
