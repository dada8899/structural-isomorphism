...
***REMOVED******REMOVED*** 27 个 dynamics_family 分类指南 + 标志性公司

***REMOVED******REMOVED******REMOVED*** 相变 / 临界现象类（最具体，优先匹配）
...
***REMOVED******REMOVED******REMOVED*** 增长类（默认倾向，谨慎使用）
