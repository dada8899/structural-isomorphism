***REMOVED*** NFLX — 从"增长机器"到"带宽有限的生态系统"
...
***REMOVED******REMOVED******REMOVED*** Twin ***REMOVED***1: Verhulst-Pearl Logistic Growth（生态学 / 种群动力学）
...
***REMOVED******REMOVED******REMOVED*** Twin ***REMOVED***2: Content Half-Life Decay with Logarithmic Refresh Budget（信息理论 / 新鲜度动力学）
...
***REMOVED******REMOVED******REMOVED*** Twin ***REMOVED***3: Competitive Exclusion / Niche Exhaustion（生态学 / 群落动力学）
...
***REMOVED******REMOVED******REMOVED*** 1. Assumption: "广告层是无限增长曲线"
...
***REMOVED******REMOVED******REMOVED*** 2. Assumption: "Password-sharing crackdown 是可持续的净增长机制"
...
***REMOVED******REMOVED******REMOVED*** 3. Assumption: "内容投入是 OpEx 杠杆，规模化会降低单用户成本"
