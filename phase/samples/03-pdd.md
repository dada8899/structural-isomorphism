***REMOVED*** Structural Report: PDD Holdings / Temu (PDD)
...
***REMOVED******REMOVED******REMOVED*** Twin ***REMOVED***1: SIR Epidemic on a Scale-Free Network（来自流行病学 / 计算社会科学）
...
***REMOVED******REMOVED******REMOVED*** Twin ***REMOVED***2: Schelling Segregation Tipping Point（来自社会物理学 / 临界相变）
...
***REMOVED******REMOVED******REMOVED*** Twin ***REMOVED***3: Invasive Species Establishment / Foothold Dynamics（来自入侵生态学）
...
***REMOVED******REMOVED*** 3. Quantified Projection: SIR on Heterogeneous Network 参数拟合

选 Twin ***REMOVED***1 做定量，因为它的状态变量（MAU、GMV）直接可测。
...
***REMOVED******REMOVED*** 4. Red Team：共识观点的三个结构性漏洞
