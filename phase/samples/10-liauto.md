...
***REMOVED******REMOVED******REMOVED*** Twin ***REMOVED***1: Competitive Exclusion Principle — Gause's Law (from Theoretical Ecology)
...
***REMOVED******REMOVED******REMOVED*** Twin ***REMOVED***2: Invasive Species Encroachment on a Specialist Niche (from Conservation Biology)
...
***REMOVED******REMOVED******REMOVED*** Twin ***REMOVED***3: Adaptive Radiation & Specialist Extinction (from Evolutionary Biology)
...
用 Twin ***REMOVED***1 的两物种 Lotka-Volterra 做基础拟合。
