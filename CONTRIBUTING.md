...
***REMOVED******REMOVED*** Setup local development
...
```bash
pytest v4/tests/sanity -m sanity -v          ***REMOVED*** unit tests
pytest v4/tests/integration -v               ***REMOVED*** integration tests
make test-all                                 ***REMOVED*** full suite (213 tests)
```
...
***REMOVED******REMOVED*** Good first issues
...
***REMOVED******REMOVED*** Reporting research issues
