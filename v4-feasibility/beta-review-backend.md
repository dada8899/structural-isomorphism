***REMOVED*** Beta Backend Code Review — structural-isomorphism/web/backend
...
***REMOVED******REMOVED*** Top 5 Most Urgent Fixes
...
***REMOVED******REMOVED*** Per-File Findings

***REMOVED******REMOVED******REMOVED*** `main.py`
...
***REMOVED******REMOVED******REMOVED*** `api/search.py`
...
***REMOVED******REMOVED******REMOVED*** `api/mapping.py`
- **P0** L71-72, L102-103 O(N) id→index scans (see Top 5 ***REMOVED***4).
...
***REMOVED******REMOVED******REMOVED*** `api/analyze.py`
...
- **P1** L231-237 retry doubles Sonnet 4.6 + 16k tokens budget (~$0.30/pair) with no user-facing cost cap. Combined with no rate limit (Top 5 ***REMOVED***3) this is a direct money-burn vector.
...
***REMOVED******REMOVED******REMOVED*** `api/daily.py`
...
***REMOVED******REMOVED******REMOVED*** `api/discoveries.py`
...
***REMOVED******REMOVED******REMOVED*** `api/examples.py`
...
***REMOVED******REMOVED******REMOVED*** `api/phenomenon.py`
...
***REMOVED******REMOVED******REMOVED*** `api/suggest.py`
- Clean. Just static list. **P2** could be static file, no endpoint needed.

***REMOVED******REMOVED******REMOVED*** `api/synthesize.py`
...
***REMOVED******REMOVED******REMOVED*** `services/search_service.py`
...
***REMOVED******REMOVED******REMOVED*** `services/llm_service.py` (1114 lines — the biggest risk surface)
...
***REMOVED******REMOVED******REMOVED*** `services/cache.py`
...
***REMOVED******REMOVED******REMOVED*** `services/v2_pairs.py`
...
***REMOVED******REMOVED*** V1→V2 Migration Residue
- `main.py:38` default `kb-5000-merged.jsonl` — **stale** (P1, Top 5 ***REMOVED***2).
