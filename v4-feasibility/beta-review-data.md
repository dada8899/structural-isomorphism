***REMOVED*** Beta Site Search Quality Review

Source: `beta-data-test-raw.json` — 15 queries against beta.structural.bytedance.city (V2 model, 4443 KB index).

***REMOVED******REMOVED*** Per-query Table

| ***REMOVED*** | Query | Lat (s) | Rel 1-5 | Div 0-1 | Top-1 result | Notes |
|---|---|---|---|---|---|---|
| 1 | 为什么创业公司早期更容易创新 | 6.3 | 2 | 1.0 | 锂离子嵌脱阶段相变 | Lexical S-curve match (***REMOVED***2/***REMOVED***3/***REMOVED***5), top-1 irrelevant |
...
| 5 | 相变 | 6.39 | 3 | 1.0 | 代币解锁的供给冲击 | Top-1 weird; 马氏体相变 only at ***REMOVED***2 (the canonical hit) |
| 6 | 为什么流言传得那么快 | 5.18 | 1 | 1.0 | 齿面点蚀的累积损伤 | Total miss. No SIR/cascade/diffusion phenomena |
| 7 | 为什么市场会崩盘 | 7.52 | 2 | 1.0 | 锂离子嵌脱阶段相变 | Only NFT bubble (***REMOVED***3) is on-target |
...
***REMOVED******REMOVED*** Overall Quality
...
***REMOVED******REMOVED*** Problem Queries (5 worst)
...
3. **"superconductor phase transition"** (rel 1): English query is broken. Top-1 is 混凝土开裂. Even 相变 (Chinese) returns 马氏体相变 at ***REMOVED***2 — but EN totally fails. The embedding model is not bilingual-aligned.
...
***REMOVED******REMOVED*** /api/discoveries
...
***REMOVED******REMOVED*** Top 3 Fix Recommendations
